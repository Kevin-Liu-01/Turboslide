...
The third parity round makes the editor a shared document with Google's collaboration surfaces, on every transport (`docs/gslides-parity/SPEC-3.md`).
