...
// A5 items 3 and 4; B7), behind GET /fonts/* (apps/studio/src/routes/fonts.$.ts). Two forms, both
// under the catalog's version so a refetch at another commit is another URL and the answers cache
// as immutable:
//
...
// `fonts/assets/*/*`, the integrator's R7). Same origin CSS and fonts need no CORS header;
