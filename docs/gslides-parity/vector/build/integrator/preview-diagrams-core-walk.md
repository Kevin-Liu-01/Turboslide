...
| `decks.file.open-list-search` | decks | works | failed | File > Open; read the list; type in the search; clear it: 60 decks listed after 8689 ms, first untitled-20260925-77p0; filtered by nonsense 0; cleared 60 | 14 |
