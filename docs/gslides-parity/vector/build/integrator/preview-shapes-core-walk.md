...
Base https://turboslide-rfp6bmnxb-kl01s-projects.vercel.app, started 2026-09-25T04:51:08.495Z, 418 s, deck untitled-20260925-038f. 595 probe rows: 58 passed, 1 failed, 0 not driven, 536 no step. Verdict failed with the parked list inbox, templates; exit 1. A row passes only when every tagged step of it passed; a not driven row is never counted as passed.
...
| `decks.save.acknowledged` | decks | flaky | passed |  | 64 |
...
| `shapes.insert.rectangle-click` | shapes | works | passed |  | 19 |
| `shapes.insert.rounded-click` | shapes | works | passed |  | 20 |
| `shapes.insert.ellipse-click` | shapes | works | passed |  | 21 |
| `shapes.insert.rectangle-drag` | shapes | works | passed |  | 22 |
| `shapes.insert.ellipse-drag` | shapes | works | passed |  | 23 |
| `shapes.insert.named-rows` | shapes | not driven | passed |  | 24 |
| `shapes.default-look` | shapes | broken | passed |  | 25 |
| `shapes.select` | shapes | works | passed |  | 26 |
| `shapes.move` | shapes | not driven | passed |  | 27 |
| `shapes.resize.eight-handles` | shapes | not driven | passed |  | 28 |
| `shapes.rotate` | shapes | not driven | passed |  | 29 |
| `shapes.fill.colour` | shapes | not driven | passed |  | 30 |
| `shapes.border.colour-weight-dash` | shapes | not driven | passed |  | 31 |
| `shapes.text.type-align-bold` | shapes | not driven | passed |  | 32 |
| `shapes.duplicate-delete-undo-redo` | shapes | not driven | passed |  | 33 |
| `shapes.format-options.size-position` | shapes | not driven | passed |  | 34 |
| `shapes.reload-and-viewer` | shapes | not driven | passed |  | 36 |
| `shapes.context.shape` | shapes | not driven | passed |  | 35 |
...
| `shapes.text.colour-toolbar` | shapes | broken | passed |  | 37 |
| `shapes.text.enter-opens-label` | shapes | works | passed |  | 38 |
| `shapes.borders-lines.menu` | shapes | works | passed |  | 39 |
...
| `decks.file.open-list-search` | decks | works | failed | File > Open; read the list; type in the search; clear it: 60 decks listed after 7132 ms, first untitled-20260925-v3i5; filtered by nonsense 0; cleared 60 | 14 |
...
| `shapes.label.centred-default` | shapes | broken | passed |  | 40 |
| `shapes.geometry.shapes.hexagon-sheet` | shapes | broken | passed |  | 43 |
| `shapes.geometry.shapes.star5-adjust` | shapes | not driven | passed |  | 44 |
| `shapes.geometry.shapes.pie-arc` | shapes | broken | passed |  | 46 |
| `shapes.geometry.shapes.multipath-can` | shapes | broken | passed |  | 47 |
| `shapes.geometry.shapes.flowchart-own-space` | shapes | broken | passed |  | 48 |
| `shapes.geometry.arrows.right-arrow` | shapes | broken | passed |  | 50 |
| `shapes.geometry.arrows.curved-right` | shapes | broken | passed |  | 51 |
| `shapes.geometry.callouts.wedge-rect` | shapes | broken | passed |  | 53 |
| `shapes.geometry.callouts.cloud` | shapes | broken | passed |  | 54 |
| `shapes.geometry.equation.plus-divide` | shapes | broken | passed |  | 56 |
| `shapes.geometry.pinned-three` | shapes | works | passed |  | 57 |
| `shapes.geometry.sites` | shapes | broken | passed |  | 59 |
| `shapes.geometry.resize-keeps-adjust` | shapes | not driven | passed |  | 45 |
| `shapes.insert.grid-shapes` | shapes | broken | passed |  | 42 |
| `shapes.insert.grid-arrows` | shapes | broken | passed |  | 49 |
| `shapes.insert.grid-callouts` | shapes | broken | passed |  | 52 |
| `shapes.insert.grid-equation` | shapes | broken | passed |  | 55 |
| `shapes.icons.named-rows` | shapes | broken | passed |  | 60 |
| `shapes.change-shape.plate` | shapes | not driven | passed |  | 61 |
| `shapes.mask-image.plate` | shapes | not driven | passed |  | 63 |
