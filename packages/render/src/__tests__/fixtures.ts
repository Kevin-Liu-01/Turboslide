...
export const catalog: Block[] = [
  ...
  { id: 'mark', type: 'mark', w: 520, h: 331 },
  {
    ...
    plate: 'lower-left',
    asset: 'opener-brand',
    caption: 'The liquid metal diamond, frozen at 5.5 s.',
  ...
  // the primitives of the freeform round (docs/freeform.md), in a flow layout here
  {
    id: 'bx',
    type: 'box',
    fill: 'plate',
    stroke: 'hair',
    padding: 16,
    text: 'A plate box with *display* text and GT inside.',
    typography: { size: 20 },
  },
  {
    id: 'bx2',
  ...
  { id: 'rect', type: 'shape', shape: 'rectangle', stroke: 'ink', width: 1.5, height: 160 },
  { id: 'round', type: 'shape', shape: 'rounded', fill: 'plate', radius: 12, height: 120 },
  { id: 'ell', type: 'shape', shape: 'ellipse', fill: 'green', stroke: 'ink', height: 200 },
  { id: 'ln', type: 'shape', shape: 'line', orientation: 'diagonal-up', width: 2, height: 100 },
  { id: 'arr', type: 'shape', shape: 'arrow', arrowheads: 'both', height: 24 },
  { id: 'rl', type: 'rule', orientation: 'horizontal' },
  { id: 'rl2', type: 'rule', orientation: 'vertical', length: 200, weight: 2, color: 'blue' },
  {
    id: 'tx',
    type: 'text',
    text: 'A text box with GT inside.',
    typography: { size: 26, weight: 500, align: 'center', tracking: -0.01, leading: 1.3 },
    color: 'ink-2',
  },
