...
| `fonts.export.pdf-face` | fonts | core/export.spec.ts | not driven | failed | TimeoutError: page.waitForEvent: Timeout 30000ms exceeded while waiting for event "download" |
...
| `svg.export.pptx-svgblip` | svg | core/export.spec.ts | not driven | failed | Error: [2mexpect([22m[31mreceived[39m[2m).[22mtoBeLessThan[2m([22m[32mexpected[39m[2m)[22m |
| `svg.export.pptx-fallback` | svg | core/export.spec.ts | not driven | failed | Error: [2mexpect([22m[31mreceived[39m[2m).[22mtoBeLessThan[2m([22m[32mexpected[39m[2m)[22m |
...
- `fonts.export.pdf-face`: TimeoutError: page.waitForEvent: Timeout 30000ms exceeded while waiting for event "download"
- `svg.export.pptx-svgblip`: Error: [2mexpect([22m[31mreceived[39m[2m).[22mtoBeLessThan[2m([22m[32mexpected[39m[2m)[22m
- `svg.export.pptx-fallback`: Error: [2mexpect([22m[31mreceived[39m[2m).[22mtoBeLessThan[2m([22m[32mexpected[39m[2m)[22m

## Measurement rows, by id (PRODUCT.md 8.2; the cost rows of SYNC.md 6.1)

- `export.download.large-deck-pdf`: passed; recorded PDF: GT brand deck.pdf, 85 slides in 13.7 s, 0.16 s per slide; PDF: GT brand deck.pdf, 85 slides in 13.7 s, 0.16 s per slide
- `export.download.large-deck-pptx`: passed; recorded Editable text PowerPoint with Embed fonts: GT brand deck (editable).pptx, 85 slides in 71.0 s, 0.83 s per slide; Editable text PowerPoint with Embed fonts: GT brand deck (editable).pptx, 85 slides in 71.0 s, 0.83 s per slide
