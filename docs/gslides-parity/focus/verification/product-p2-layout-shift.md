...
Base http://localhost:4344, deck gt-brand, 22 cells in 234 s, Chromium 147.0.7727.15 (Chrome for Testing 147.0.7727.15, ANGLE Metal, no WebGL), 2026-09-21T07:03:28.377Z.
...
- edit 1440 light: write (enter failed: page.evaluate: RangeError: Unknown action "slide.setNotes"
  at t (http://localhost:4344/assets/useStudioSession-BbbnvwKt.js:1:1930)
  at Object.dispatch (http://localhost:4344/assets/useStudioSession-BbbnvwKt.js:1:2130)
  at Nt (http://localhost:4344/assets/EditorRoot-aAgOlj-5.js:25:32076)
  at Object.<anonymous> (http://localhost:4344/assets/useStudioSession-BbbnvwKt.js:1:2795)
  at ot (http://localhost:4344/assets/useStudioSession-BbbnvwKt.js:1:9029)
  at Object.invoke (http://localhost:4344/assets/useStudioSession-BbbnvwKt.js:1:11507)
