...
- `shaders.frame.auto-capture`: Error: a frameKey
- `shaders.frame.box-aspect`: Error: within 48 per channel
- `shaders.frame.reuse-and-prune`: Error: the repeated recipe reuses its asset id
...
- `shaders.perf.editor-frame`: failed (Error: under 150 ms); recorded longest animation frame 425.7 ms over 5 s with one shader on the stage (551 animation frames; rAF gaps; 1 canvas; renderer ANGLE (Google, Vulkan 1.3.0 (SwiftShader Device (LLVM 10.0.0) (0x0000C0DE)), SwiftShader driver)); longest animation frame 425.7 ms over 5 s with one shader on the stage (551 an
