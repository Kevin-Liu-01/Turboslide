...
| `decks.save.acknowledged` | decks | flaky | passed |  | 620 |
| `decks.editor.move-to-trash` | decks | works | passed |  | 621 |
...
| `surface.menus.open-close-escape` | surface | not driven | passed |  | 619 |
| `surface.cleanup` | surface | works | passed |  | 622 |
...
| `chrome.split.one-box` | chrome | broken | passed |  | 587 |
| `chrome.split.hover-no-inversion` | chrome | broken | passed |  | 588 |
| `chrome.split.click-show` | chrome | works | passed |  | 589 |
| `chrome.split.chevron-menu-aligned` | chrome | broken | passed |  | 590 |
| `chrome.split.enter-chevron` | chrome | broken | passed |  | 591 |
| `chrome.split.enter-label` | chrome | broken | passed |  | 592 |
| `chrome.split.space-both` | chrome | works | passed |  | 593 |
| `chrome.split.arrow-down-label` | chrome | broken | passed |  | 594 |
| `chrome.split.tab-order` | chrome | flaky | passed |  | 595 |
| `chrome.split.aria` | chrome | broken | passed |  | 596 |
| `chrome.split.collapse-900` | chrome | broken | passed |  | 597 |
| `chrome.separators.once` | chrome | broken | passed |  | 598 |
| `chrome.separators.toolbar-dividers` | chrome | works | passed |  | 599 |
| `chrome.cluster.gaps-heights` | chrome | broken | passed |  | 600 |
| `chrome.comments-glyph.toggle` | chrome | broken | passed |  | 601 |
...
| `versions.show-changes-marks` | versions | not driven | failed | a heading edit and an added box after the named version; pick the older version with Show changes on; then off: picked versionHistory.883.pick (named row versionHistory.883.pick); marks with Show changes on 0 (); off 0 | 488 |
| `help.check-slides` | help | works | passed |  | 512 |
| `inbox.bell-panel-toggle` | inbox | broken | failed | click the bell; read the panel; click the bell again: with the switch on; panel open true (aria-pressed true); words "NotificationsMark all readNothing newNotification settings"; Mark all read true; settings link true; panel still open after the second click true (aria-pressed true) | 584 |
| `inbox.settings-persist` | inbox | broken | failed | Tools > Notification settings, None, Save; reopen; reload: level forYou -> picked none; Save closed true; reopened forYou; after a reload forYou | 585 |
...
| `chrome.bottom-bar.removed` | chrome | broken | passed |  | 602 |
| `chrome.menu.no-tooltip-with-submenu` | chrome | broken | passed |  | 603 |
| `chrome.menu.escape-focus-stage` | chrome | broken | passed |  | 604 |
| `chrome.presence.tooltip` | chrome | broken | passed |  | 605 |
| `chrome.contrast.titanium-light` | chrome | broken | passed |  | 606 |
| `chrome.disabled.token-both-appearances` | chrome | not driven | passed |  | 607 |
| `chrome.field.boundary-3-1` | chrome | broken | passed |  | 608 |
| `chrome.hover.ground` | chrome | broken | passed |  | 609 |
| `chrome.floating.edge-frame` | chrome | broken | passed |  | 610 |
| `chrome.focus.one-ring-rule` | chrome | broken | passed |  | 611 |
| `chrome.filmstrip.one-ring` | chrome | broken | passed |  | 612 |
| `chrome.tooltip.none-on-focus-in-menus` | chrome | broken | passed |  | 613 |
| `chrome.menu.plate-fits-labels` | chrome | broken | passed |  | 614 |
| `chrome.menu.no-mnemonics-mac` | chrome | broken | passed |  | 615 |
| `chrome.select.one-rule` | chrome | broken | passed |  | 616 |
| `chrome.check.draws-check` | chrome | broken | passed |  | 617 |
| `chrome.toolbar.bold-follows-selection` | chrome | broken | passed |  | 618 |
...
| `assist.entry.title-row` | assist | not driven | passed |  | 576 |
| `assist.panel.first-line-and-cards` | assist | not driven | passed |  | 577 |
| `assist.tailor.dialog-one-undo` | assist | not driven | passed |  | 578 |
| `assist.tailor.agent-deck-tailor` | assist | not driven | passed |  | 579 |
| `assist.outside-write.snackbar` | assist | broken | passed |  | 580 |
| `assist.finder.terms` | assist | broken | passed |  | 581 |
| `assist.finder.ask-row` | assist | not driven | passed |  | 582 |
| `assist.agent.propose-accept` | assist | not driven | passed |  | 583 |
