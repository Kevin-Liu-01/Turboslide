...
// round, ship one (docs/FEATURES.md section 4, 7.1) the logo picker, and the vector round
// (docs/VECTOR.md section 4, 6.1) the SVG pictures. Node only; no dependency.
