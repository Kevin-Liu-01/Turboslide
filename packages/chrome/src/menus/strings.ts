...
export const PANELS = {
  ...
  brand: {
    ...
    dark: 'Dark',
    hexDoc:
      'Six hex digits; typing previews on the slides, Enter keeps it, Escape puts the field back',
    fonts: 'Fonts',
    display: 'Display',
    displayDoc: 'The face of every heading',
    text: 'Text',
    textDoc: 'The face of the body text, captions and labels',
    footer: 'Footer',
    footerLogo: 'Logo',
    footerLogoDoc: 'The logo in the footer of every slide but the title',
    footerText: 'Text',
    footerTextDoc:
    ...
    counterSkip: 'Skip title slides',
    frame: 'Frame',
    frameRails: 'Rails',
    frameRailsLine: 'Rails: the margins at the sides of every slide',
    frameRules: 'Rules',
    frameRulesLine: 'Rules: the thin lines that frame the slide',
    frameCrosses: 'Crosses',
    frameCrossesLine: 'Crosses: the small marks at the frame’s corners',
    lexicon: 'Words that never translate',
